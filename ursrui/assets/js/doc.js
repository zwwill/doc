...
$(function() {
    ...
    function navInit() {
        ...
        sidebar.find(' > dt > span').click(function() {
            $(this).toggleClass('glyphicon-plus').toggleClass('glyphicon-minus').parent().next().toggleClass('hide');
        })
    ...
    function loadDemo() {
        ...
        if (win && win.__st_render) {
            ...
            setInterval(function () {
                var h1 = win.document.body.scrollHeight,
                    h2=ifr.height();
                if(h1 != h2){
                    ifr.height(win.document.body.scrollHeight);
                }
            ...
            if (text) {
                ...
                filterItems.forEach(function(item) {
                    ...
                    if (fnMatch(item.name)) {
                        ...
                        _tpy = (itemTag || item.type) == 'class' ? 'unit':'module';

                        result.push('">', item.name, "  <em><small>[",_tpy, "]</small></em></a></li>");
                    }
                })
